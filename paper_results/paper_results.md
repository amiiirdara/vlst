...
**Code now:** SHAP fits and explains the **full cohort** (same `X_all`, `y_all` as FFS/MI). **[STALE]** The PNGs and numbers in this section are still the previous 15-case run.

#### Figure 3. SHAP summary

![Figure 3](05_tabpfn_interpretability/paper_figures/paper_fig3_shap_summary.png)

**Figure 3.** **[STALE PNG]** Stored beeswarm is from the deleted 15-case slice. After re-run this is a full-cohort beeswarm.
...
**Figure 5.** **[STALE PNG / numbers]** Mean(|SHAP|) from the old 15-case slice. After re-run this is mean(|SHAP|) on the full cohort.
...
k-SII plots use **one illustrative row** (row 0 of the full cohort; budget = 256). They are not a cohort interaction screen. **[STALE]** Stored figures 8–12 are still the old VLST-case row.
